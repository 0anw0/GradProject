...
export function LikeModal({ likersModalVisible, postKey, setLikersModalVisible,
    likers, updateLikersState , loadLikes , loadLikesBoolean}) {

    return (
        <Modal
            animationType="slide"
            visible={likersModalVisible}
            onShow={async () => likersHandler(postKey, updateLikersState , loadLikesBoolean)}
