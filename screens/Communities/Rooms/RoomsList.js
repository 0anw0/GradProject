    ...
    return (
      <View style={{ marginTop: StatusBar.currentHeight, flex: 1 }}>
        <Header
          ...
          type="font-awesome"
          onPress={() =>
            this.navigate("CreateRoom", { communityKey: this.communityKey })
          }
        />
        {this.state.loaded ? (
          !this.state.existRooms ? (
            <TouchableButton
              ...
              size={30}
              color={"blue"}
              txtValue={"Create Your First Room!"}
              ...
              renderItem={({ item }) => (
                <View style={[styles.container]}>
                  ...
                  <View underlayColor="#fff" style={styles.item}>
                    ...
                    >
                      <SubButton
                        actionFunc={() => this.openMessages(item)}
                        iconName={"comments-o"}
                      />
                      ...
                      />
                      <SubButton
                        actionFunc={() => this.updateRoom(item)}
